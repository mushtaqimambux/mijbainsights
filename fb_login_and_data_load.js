document.addEventListener("DOMContentLoaded", function() {
   ...
   function facebookLogin() {
    ...
    function fetchVideos() {
        ...
        fetchVideosWithPagination(`/${pageId}/videos?fields=id,title,description,created_time,permalink_url,views,shares,comments.limit(0).summary(true)&since=${startDate}&until=${endDate}`);
    }
    ...
    function sortVideos(criteria, order) {
        videosList.sort((a, b) => {
            ...
            } else if (criteria === 'shares') {  // ✅ Shares Sorting Added
